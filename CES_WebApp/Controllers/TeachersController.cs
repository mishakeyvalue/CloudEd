...
namespace CES_WebApp.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Login,Password")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Login,Password")] Teacher teacher)
        {
            if (id != teacher.ID)
            {
                return NotFound();
